...
CREATE TABLE IF NOT EXISTS responses (
    ...
    CONSTRAINT  fk_response_on_request FOREIGN KEY (request_id) REFERENCES requests (request_id),
    CONSTRAINT  fk_response_on_item FOREIGN KEY (item_id) REFERENCES items (item_id),
    CONSTRAINT  fk_response_on_user FOREIGN KEY (owner_id) REFERENCES users(user_id)
);